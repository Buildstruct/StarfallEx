...
function weapon_methods:maxClip1()
	return Wep_GetMaxClip1(unwrap(self))
end
...
function weapon_methods:getPrimaryAmmoType()
	return Wep_GetPrimaryAmmoType(unwrap(self))
end
...
function weapon_methods:getSecondaryAmmoType()
	return Wep_GetSecondaryAmmoType(unwrap(self))
end
...
function weapon_methods:isWeaponVisible()
	return Wep_IsWeaponVisible(unwrap(self))
end
...
function weapon_methods:lastShootTime()
	return Wep_LastShootTime(unwrap(self))
end
...
function weapon_methods:getViewModel()
	return Wep_GetWeaponViewModel(unwrap(self))
end
...
function weapon_methods:getWorldModel()
	return Wep_GetWeaponWorldModel(unwrap(self))
end
